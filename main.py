...
def run(args):
    ...
    trainer = SCCLvTrainer(model, tokenizer, optimizer, train_loader, args, cluster_centers=cluster_centers)
    trainer.train()
...
def get_args(argv):
    ...
    # Dataset
    # parser.add_argument('--datapath', type=str, default='/home/lijintong/SCCL-EXEC-main/AugData/Agnews')
    # parser.add_argument('--dataname', type=str, default='agnews_charswap_20', help="")
    # parser.add_argument('--num_classes', type=int, default=4, help="")
    parser.add_argument('--datapath', type=str, default='/home/lijintong/sccl-main/AugData/augdata')
    parser.add_argument('--dataname', type=str, default='snippets_charswap_20', help="")
    ...
    parser.add_argument('--temperature_centers', type=float, default=0.5, help="temperature required by clustering centers")
